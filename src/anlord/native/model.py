...
# Native adaptation of abliteration/model.py — behavior identical to p-e-w/abliteration 1.4.0
# Changes: NativeConfig instead of Settings, imports adjusted for Anlord layout,
# no abliteration-llm runtime dependency.
...
from .config import QuantizationMethod, RowNormalization, NativeConfig
from .prompts import Prompt, batchify
